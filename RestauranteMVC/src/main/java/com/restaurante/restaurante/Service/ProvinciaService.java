...
public class ProvinciaService {
    ...
    private JdbcTemplate jdbcTemplate;
     ...
     public List<Provincia> obtenerProvincias() {
        String sql = "SELECT ID_PROVINCIA, NOMBRE FROM FIDE_PROVINCIA_TB";
     ...
     public Provincia obtenerProvinciaPorId(int id) {
        String sql = "SELECT ID_PROVINCIA, NOMBRE FROM FIDE_PROVINCIA_TB WHERE ID_PROVINCIA = ?";
    ...
    public void actualizarProvincia(Integer idProvincia, String nombre, Integer idEstado) {
        String sql = "{call ACTUALIZAR_PROVINCIA(?, ?, ?)}";
    ...
    public void eliminarProvincia(Integer idProvincia) {
        String sql = "{call ELIMINAR_PROVINCIA(?)}";
